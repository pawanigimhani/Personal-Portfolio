  ...
  return (
    <div>
      ...
      <div className="py-12 sm:py-8">
        <h1 className="text-secondary text-xl sm:text-lg">Here are some technologies that I 've worked with recently</h1>
       <div className="flex flex-wrap gap-10 sm:gap-5 mt-5 sm:my-6">
       {skill.map((tech) => (
            <div className="text-white border border-white py-3 px-10 sm:px-5 sm:py-2 sm:text-sm rounded hover:bg-white hover:text-primary hover:scale-105 hover:shadow-lg transition-all duration-300">
                <h1>{tech}</h1>
            </div>
        ))}
      </div>
